      ...
      <div className="w-full">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
          ...
          <div className="flex gap-3 mt-4 lg:mt-0">
            <Link href={'/dashboard/send-sms'} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors">
              <Send className="w-4 h-4" />
              Send SMS
            </Link>
            <Link href={'/dashboard/campaigns/new'} className="border border-gray-300 hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-lg flex items-center gap-2 transition-colors">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-gray-600 rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <Link href={'/dashboard/campaigns'} className="w-full mt-6 text-black border rounded-sm bg-white dark:bg-gray-600 hover:bg-gray-100 dark:hover:bg-gray-200 hover:text-gray-900 py-2 flex items-center justify-center gap-2 transition-colors">
        ...
        <div className="mt-8 bg-white dark:bg-gray-600 rounded-xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link href={'/dashboard/send-sms'}  className="p-6 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 transition-all text-left group">
            ...
            <Link href={'/dashboard/campaigns/new'}  className="p-6 border border-gray-200 rounded-xl hover:border-green-300 hover:bg-green-50 transition-all text-left group">
            ...
            <Link href={'/dashboard/reports'}  className="p-6 border border-gray-200 rounded-xl hover:border-purple-300 hover:bg-purple-50 transition-all text-left group">
